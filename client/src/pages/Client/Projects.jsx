...
export default function ClientProjects() {
    ...
    const [projects] = useState([
        {
            ...
            milestones: [
                { name: "Database Setup", status: "completed", amount: 1500 },
                { name: "Frontend Development", status: "in_progress", amount: 2000 },
                { name: "Payment Integration", status: "pending", amount: 1500 },
            ],
        },
        {
            id: 2,
            title: "Mobile App UI/UX Design",
            description: "Design a modern mobile app interface for iOS and Android",
            ...
            milestones: [
                { name: "Wireframes", status: "pending", amount: 1000 },
                { name: "UI Design", status: "pending", amount: 1500 },
                { name: "Prototype", status: "pending", amount: 500 },
            ],
        },
        {
            id: 3,
            title: "Content Writing for Blog",
            description: "Write 20 SEO-optimized blog posts for tech startup",
            status: "completed",
            budget: 800,
            deadline: "2024-01-30",
            proposals: 5,
            ...
            milestones: [
                { name: "Research & Outline", status: "completed", amount: 200 },
                { name: "First 10 Articles", status: "completed", amount: 400 },
                { name: "Final 10 Articles", status: "completed", amount: 200 },
            ],
        },
        {
            id: 4,
            title: "WordPress Website Redesign",
            description: "Redesign existing WordPress site with modern theme",
            status: "open",
            budget: 2500,
            deadline: "2024-03-01",
            proposals: 15,
            ...
            milestones: [
                { name: "Theme Selection", status: "pending", amount: 500 },
                { name: "Content Migration", status: "pending", amount: 1000 },
                { name: "Customization", status: "pending", amount: 1000 },
            ],
        },
    ])
    ...
    const projectsByStatus = {
        ...
        pending_proposals: filteredProjects.filter((p) => p.status === "pending_proposals"),
            ...
            <div className="w-full mx-auto lg:ml-64">
                ...
                <div className="flex items-center jusify-start  lg:justify-between">
                    ...
                    <div className="ml-1">
                        ...
                        <p className="text-gray-600 my-5 sm:my-2">Manage and track all your projects</p>
                    </div>
                    <button className="bg-gradient-to-r ml-11 from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-all ">
                    ...
                    <div className="space-y-4">
                        {currentProjects.length === 0 ? (
                            ...
                            currentProjects.map((project) => (
                                <div key={project.id} className="bg-white rounded-lg shadow-sm border hover:shadow-lg transition-shadow p-6">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex flex-wrap gap-1 mb-3">
                                                {project.skills.map((skill, index) => (
                                                    <span key={index} className="px-2 py-1 border border-gray-300 rounded-md text-xs text-gray-700">
                                                        {skill}
                                                    </span>
                                                ))}
                                            </div>
                                        ...
                                        <div className="flex items-center gap-3 mb-4 p-3 bg-gray-50 rounded-lg">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <span className="text-sm text-gray-600">{project.freelancer.rating}</span>
                                                </div>
                                            </div>
